...
struct vector3_t {
	...
	static float length2d(const vector3_t& v) noexcept;
...
inline float vector3_t::length2d() const noexcept {
	return length2d(*this);
}
...
inline float vector3_t::length2d(const vector3_t& v) noexcept {
